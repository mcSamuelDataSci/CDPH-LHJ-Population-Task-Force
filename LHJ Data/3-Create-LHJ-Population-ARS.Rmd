...
Note: Negative population estimates are calculated for 29 sex-age-race-health department stratas. These all occur in Multi-Race and AI/AN 95+ year olds whose populations are very small. These negative values are set to 0.
...
lhjARS_old <- readRDS(paste0(outputDir, "lhj-pop-ars-2000-cy.RDS")) %>% 
...
saveRDS(lhjARS, paste0(outputDir, "lhj-pop-ars-2000-", maxYear, ".RDS"))
write_csv(lhjARS, paste0(outputDir, "lhj-pop-ars-2000-", maxYear, ".csv"))
