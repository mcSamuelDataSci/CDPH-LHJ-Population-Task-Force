...
1.  intermediatePopData/lhj-population-total.RDS
...
if (adjust) {
  ...
  write_csv(lhjARS_csv, paste0(outputDir, "lhj-population-ars-adjJuly.csv"))
} else {
  saveRDS(lhjARS, paste0(outputDir, "lhj-population-ars.RDS"))
  write_csv(lhjARS_csv, paste0(outputDir, "lhj-population-ars.csv"))
}
