...
1.  Department of Finance (DOF) P3 Complete State and County Projections Dataset
    ...
    1.  Files processed:
        ...
        1.  *P3/P3_Complete_2010-2060.csv*
            ...
            3.  2010-2023 population estimates are used.
        ...
        3.  Note: Both files contain sex by age by race/ethnicity population estimates at the county-level.

2.  2020 Census Decennial for county- and city-level Sex-Age-Race/Ethnicity population
...
# Set current year
currentYear <- 2023 # July E6 - most recent year available
currentYear_Jan <- 2024 # Jan E4 - most recent year available
