# myServer <- F
# if (!myServer) source("g:/FusionData/0.CCB/myCCB/Standards/FusionStandards.R")
# if (myServer) source("/mnt/projects/FusionData/0.CCB/myCCB/Standards/FusionStandards.R")
...
if (!CCB & !myServer) myPlace <- "g:/FusionData/0.CCB/myCCB"
if (!CCB & myServer)  myPlace <- "/mnt/projects/FusionData/0.CCB/myCCB"
...
if (myServer) highPath <-  "/mnt/projects/"
if(!myServer) highPath <-  "G:/"
